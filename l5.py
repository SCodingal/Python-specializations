...
background= pygame.transform.scale(
    pygame.image.load('bg.jpg').convert_alpha(), (SCREEN_WIDTH,SCREEN_HEIGHT))
...
for i in range(num_of_enemies):
    enemyIng.append(pygame.transform.scale(
    pygame.image.load('enemy.png').convert_alpha(), (40,40)))
    enemyX.append(random.randint(0, SCREEN_WIDTH - 64))

    enemyY.append(random.randint(ENEMY_START_Y_MIN, ENEMY_START_Y_MAX))
    enemyX_change.append(ENEMY_SPEED_X)
    enemyY_chnage.append(ENEMY_SPEED_Y)


bulletImg= pygame.transform.scale(
    pygame.image.load('bullet.png').convert_alpha(), (20,20))
bulletX=0
bulletY= PLAYER_START_Y
bullet_change= 0
bulletY_chnage= BULLET_SPEED_Y
bullet_state= "ready"
