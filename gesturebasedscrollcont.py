...
def detect_gestures(landmarks,handednesss):
    fingers = []
...
print("Gesture Scroll Control Activate/nOpen palm: Scroll Up/nClosed fist: Scroll Down/nPress 'q' to exit")
...
while cap.isOpened():
    ...
    if results.muilti_hand_landmarks:
    ...
    cv2.imshow("Gesture Cnontrol", cv2.cvtColor(img, cv2.COLOR_RGB2RGB))
